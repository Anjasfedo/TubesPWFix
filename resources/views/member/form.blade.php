      ...
      <form action="" method="post" class="form-horizontal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              {{-- <div class="form-group row">
                <label for="opsi_member" class="col-md-2 col-md-offset-1 control-label">Kategori</label>
                <div class="col-md-9">
                    <select name="opsi_member" id="opsi_member" class="form-control" required>
                      <option value="">Pilih Kategori</option>
                      <option value="30000">Silver</option>
                      <option value="50000">gold</option>
                    </select>
                    <span class="help-block with-errors"></span>
                </div>
              </div> --}}
