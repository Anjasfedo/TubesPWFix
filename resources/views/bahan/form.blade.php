        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group row">
                <label for="nama_bahan" class="col-md-2 col-md-offset-1 control-label">nama</label>
                <div class="col-md-9">
              ...
              <div class="form-group row">
                <label for="id_jenis" class="col-md-2 col-md-offset-1 control-label">jenis</label>
                <div class="col-md-9">
